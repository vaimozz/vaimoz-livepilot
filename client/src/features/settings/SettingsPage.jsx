    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Kelola integrasi API dan notifikasi</p>
        </div>
        <Button onClick={loadChannels} disabled={isLoadingChannels} className="gap-2">
      ...
      <Card>
        <CardContent className="p-6">
          <SectionTitle icon={KeyRound} title="Integrasi YouTube" />
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex gap-2">
                  {connectedChannels.length > 0 && (
                    <Button onClick={disconnectAllChannels} variant="outline" size="sm" className="gap-2">
              ...
              {connectedChannels.length === 0 ? (
                <div className="border border-dashed border-gray-300 rounded-lg p-8 text-center">
                  <p className="text-sm text-gray-500">Belum ada channel terhubung</p>
                  <Button onClick={addChannel} className="mt-3 gap-2">
                ...
                <div className="space-y-2">
                  {connectedChannels.map((ch) => (
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        {!ch.is_default && (
                          <Button onClick={() => setDefaultChannel(ch.id)} variant="outline" size="sm">
                            Set Default
                          </Button>
                        )}
                        <Button onClick={() => deleteChannel(ch)} variant="outline" size="sm" className="text-red-600 hover:text-red-700">
                          <Trash2 className="h-3 w-3" />
                        </Button>
                      </div>
                    </div>
