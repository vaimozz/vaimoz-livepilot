        ...
        <div className="flex min-h-[calc(100vh-4rem)]">
          ...
          <main className="min-w-0 flex-1 p-5 pb-24 lg:p-8 lg:pb-8">
            <div className="mb-5 flex items-center justify-between lg:hidden">
              <div className="flex items-center gap-3"><div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-cyan-500"><MonitorPlay className="h-5 w-5 text-white dark:text-slate-950" /></div><div><p className="font-bold">Live Pilot</p><p className="text-xs text-gray-500 dark:text-slate-500">Pratinjau mobile</p></div></div>
            </div>
